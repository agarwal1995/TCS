    ...
    private void text_lbnmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_lbnmKeyPressed
       if(evt.getKeyCode()== KeyEvent.VK_ENTER)
       {
        ...
        try {
            ...
            String s="select id,firstname,surname,dob,contact,email,gender from student_info;";
        ...
        else
        {
            ...
            String s="select id,firstname,surname,dob,contact,email,gender from student_info where firstname = ?;";
            ps=cn.prepareStatement(s);
